// Excerpts from "Alice's Adventures in Wonderland" by Lewis Carroll (public domain)

export const ALICE_SENTENCES = [
...
export const ALICE_RESPONSES = [
  ...
  "Well! thought Alice to herself, after a fall like this, I shall think nothing of tumbling down stairs!",
  "How brave they'll all think me at home! Why, I wouldn't say anything about it, even if I fell off the top of the house!",
];

export const ALICE_PARAGRAPHS = [
  ...
  "Then she looked at the sides of the well, and noticed that they were filled with cupboards and book-shelves; here and there she saw maps and pictures hung upon pegs. She took down a jar from one of the shelves as she passed; it was labelled ORANGE MARMALADE.",
  ...
  "Well! thought Alice to herself, after a fall like this, I shall think nothing of tumbling down stairs! How brave they'll all think me at home! Why, I wouldn't say anything about it, even if I fell off the top of the house!",
];
